...
public class GameController : MonoBehaviour {
	...
	public GUIText start, startPointer, control, controlPointer;
	...
	void splash () {
		...
		if(Input.GetKeyDown (KeyCode.DownArrow) || Input.GetKeyDown (KeyCode.S)){
			controlPointer.enabled = true;
			startPointer.enabled = false;
		}
		if(Input.GetKeyDown (KeyCode.UpArrow) || Input.GetKeyDown (KeyCode.W)){
			startPointer.enabled = true;
			controlPointer.enabled = false;
		}
		
		if(Input.GetKeyDown(KeyCode.Space)){
			if(startPointer.enabled)	{
			...
			else if(controlPointer.enabled)	{
				control.enabled = false;
				start.enabled = false;
				startPointer.enabled = false;
				controlPointer.enabled = false;
